...
type GetTopGamesRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to GameDetails:
	//
	//	*GetTopGamesRequest_Year
	//	*GetTopGamesRequest_Limit
	GameDetails   isGetTopGamesRequest_GameDetails `protobuf_oneof:"game_details"`
...
func (x *GetTopGamesRequest) GetGameDetails() isGetTopGamesRequest_GameDetails {
	if x != nil {
...
func (x *GetTopGamesRequest) GetYear() string {
	if x != nil {
		if x, ok := x.GameDetails.(*GetTopGamesRequest_Year); ok {
			return x.Year
		}
	}
	return ""
...
func (x *GetTopGamesRequest) GetLimit() uint32 {
	if x != nil {
		if x, ok := x.GameDetails.(*GetTopGamesRequest_Limit); ok {
			return x.Limit
		}
	}
	return 0
...
type isGetTopGamesRequest_GameDetails interface {
	isGetTopGamesRequest_GameDetails()
}

type GetTopGamesRequest_Year struct {
	Year string `protobuf:"bytes,1,opt,name=year,proto3,oneof"`
}

type GetTopGamesRequest_Limit struct {
	Limit uint32 `protobuf:"varint,2,opt,name=limit,proto3,oneof"`
}

func (*GetTopGamesRequest_Year) isGetTopGamesRequest_GameDetails() {}

func (*GetTopGamesRequest_Limit) isGetTopGamesRequest_GameDetails() {}
...
func (x *GetTopGamesResponse) GetGames() []*Game {
	if x != nil {
		return x.Games
	}
	return nil
...
type DeleteGameResponse struct {
	...
	ReleaseYear   *date.Date             `protobuf:"bytes,3,opt,name=release_year,json=releaseYear,proto3" json:"release_year,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *DeleteGameResponse) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *DeleteGameResponse) GetReleaseYear() *date.Date {
	if x != nil {
		return x.ReleaseYear
	}
	return nil
...
var file_game_game_proto_rawDesc = string([]byte{
	...
	0x22, 0x30, 0x0a, 0x0e, 0x41, 0x64, 0x64, 0x47, 0x61, 0x6d, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x1e, 0x0a, 0x04, 0x67, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x0a, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x47, 0x61, 0x6d, 0x65, 0x52, 0x04, 0x67, 0x61,
	0x6d, 0x65, 0x22, 0x2a, 0x0a, 0x0f, 0x41, 0x64, 0x64, 0x47, 0x61, 0x6d, 0x65, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x67, 0x61, 0x6d, 0x65, 0x5f, 0x69, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x67, 0x61, 0x6d, 0x65, 0x49, 0x64, 0x22, 0x29,
	...
	0x04, 0x52, 0x06, 0x67, 0x61, 0x6d, 0x65, 0x49, 0x64, 0x22, 0x31, 0x0a, 0x0f, 0x47, 0x65, 0x74,
	...
	0x68, 0x2e, 0x47, 0x61, 0x6d, 0x65, 0x52, 0x04, 0x67, 0x61, 0x6d, 0x65, 0x22, 0x7e, 0x0a, 0x12,
	0x47, 0x65, 0x74, 0x54, 0x6f, 0x70, 0x47, 0x61, 0x6d, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x14, 0x0a, 0x04, 0x79, 0x65, 0x61, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x48, 0x00, 0x52, 0x04, 0x79, 0x65, 0x61, 0x72, 0x12, 0x16, 0x0a, 0x05, 0x6c, 0x69, 0x6d, 0x69,
	...
	0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x04, 0x74, 0x61, 0x67, 0x73, 0x42, 0x0e, 0x0a, 0x0c,
	0x67, 0x61, 0x6d, 0x65, 0x5f, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x22, 0x37, 0x0a, 0x13,
	0x47, 0x65, 0x74, 0x54, 0x6f, 0x70, 0x47, 0x61, 0x6d, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x12, 0x20, 0x0a, 0x05, 0x67, 0x61, 0x6d, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x47, 0x61, 0x6d, 0x65, 0x52, 0x05,
	0x67, 0x61, 0x6d, 0x65, 0x73, 0x22, 0x2c, 0x0a, 0x11, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x47,
	...
	0x65, 0x49, 0x64, 0x22, 0x79, 0x0a, 0x12, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x47, 0x61, 0x6d,
	...
	,
	...
	0x67, 0x61, 0x6d, 0x65, 0x2f, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x2f, 0x7b, 0x67, 0x61, 0x6d,
	0x65, 0x5f, 0x69, 0x64, 0x7d, 0x42, 0x35, 0x5a, 0x33, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x61, 0x72, 0x69, 0x79, 0x61, 0x32, 0x33, 0x2f, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x5f, 0x61, 0x70, 0x69, 0x5f, 0x67, 0x61, 0x6d, 0x65, 0x73, 0x2f, 0x67, 0x65, 0x6e,
	0x2f, 0x67, 0x61, 0x6d, 0x65, 0x3b, 0x67, 0x61, 0x6d, 0x65, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
})
...
var file_game_game_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_game_game_proto_goTypes = []any{
	(*Game)(nil),                // 0: auth.Game
	(*AddGameRequest)(nil),      // 1: auth.AddGameRequest
	(*AddGameResponse)(nil),     // 2: auth.AddGameResponse
	(*GetGameRequest)(nil),      // 3: auth.GetGameRequest
	(*GetGameResponse)(nil),     // 4: auth.GetGameResponse
	(*GetTopGamesRequest)(nil),  // 5: auth.GetTopGamesRequest
	(*GetTopGamesResponse)(nil), // 6: auth.GetTopGamesResponse
	(*DeleteGameRequest)(nil),   // 7: auth.DeleteGameRequest
	(*DeleteGameResponse)(nil),  // 8: auth.DeleteGameResponse
	(*date.Date)(nil),           // 9: google.type.Date
}
var file_game_game_proto_depIdxs = []int32{
	9, // 0: auth.Game.release_year:type_name -> google.type.Date
	0, // 1: auth.AddGameRequest.game:type_name -> auth.Game
	0, // 2: auth.GetGameResponse.game:type_name -> auth.Game
	0, // 3: auth.GetTopGamesResponse.games:type_name -> auth.Game
	9, // 4: auth.DeleteGameResponse.release_year:type_name -> google.type.Date
	1, // 5: auth.GameService.AddGame:input_type -> auth.AddGameRequest
	3, // 6: auth.GameService.GetGame:input_type -> auth.GetGameRequest
	5, // 7: auth.GameService.GetTopGames:input_type -> auth.GetTopGamesRequest
	7, // 8: auth.GameService.DeleteGame:input_type -> auth.DeleteGameRequest
	2, // 9: auth.GameService.AddGame:output_type -> auth.AddGameResponse
	4, // 10: auth.GameService.GetGame:output_type -> auth.GetGameResponse
	6, // 11: auth.GameService.GetTopGames:output_type -> auth.GetTopGamesResponse
	8, // 12: auth.GameService.DeleteGame:output_type -> auth.DeleteGameResponse
...
func file_game_game_proto_init() {
	...
	file_game_game_proto_msgTypes[5].OneofWrappers = []any{
		(*GetTopGamesRequest_Year)(nil),
		(*GetTopGamesRequest_Limit)(nil),
	}
	type x struct{}
